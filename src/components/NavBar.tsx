    ...
    >
      ...
      {scrolled && (
        <div className="fixed bottom-4 left-4 right-4 z-50 md:hidden">
          <a
            href="https://app.lcadesk.com/auth/signup?role=filer"
            className="flex items-center justify-center gap-2 w-full rounded-xl bg-gradient-to-r from-accent to-teal py-3.5 text-sm font-semibold text-white shadow-xl shadow-accent/30"
          >
            Start Free Trial
          </a>
        </div>
