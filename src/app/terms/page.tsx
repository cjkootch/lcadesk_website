      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="space-y-10 text-sm text-text-secondary leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">The Service, including its software, design, branding, documentation, and all AI-generated templates and report structures, is owned by LCA Desk and protected by intellectual property laws. You may not copy, modify, distribute, reverse-engineer, or create derivative works of any part of the Service.</p>
