...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://lcadesk.com/blog/${slug}` },
    openGraph: {
      title: post.title,
      description: post.description,
      type: "article",
        ...
        <div className="max-w-2xl mx-auto px-6">
          <div className="bg-gradient-to-r from-accent/5 to-teal/5 border border-accent/20 rounded-2xl p-8 text-center">
            ...
            <p className="text-sm text-text-secondary max-w-lg mx-auto mb-5">
              LCA Desk automates report generation, flags compliance gaps, and tracks your deadlines. 30-day free trial — no card required.
            </p>
            <Link
