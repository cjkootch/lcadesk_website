...
export default function TrinidadPage() {
  ...
  return (
    <main className="min-h-screen bg-surface">
      <HeroSection
        eyebrow="\u{1F1F9}\u{1F1F9} Trinidad & Tobago"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <p className="text-sm font-medium text-text-primary">
                MEEI Permanent Local Content Committee (PLCC)
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-5">
              <p className="text-xs uppercase tracking-wider text-text-muted mb-1">
              ...
              <p className="text-sm font-medium text-text-primary">
                Local Content and Local Participation Policy Framework (2004)
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-5">
              <p className="text-xs uppercase tracking-wider text-text-muted mb-1">
        ...
        >
          <div className="bg-card rounded-xl border border-border p-6 max-w-md w-full text-center">
            ...
            <p className="text-sm text-text-secondary mb-4">
              Be the first to know when the Trinidad &amp; Tobago module
              launches.
            </p>
            {submitted ? (
            ...
            <p className="text-xs text-text-muted mt-4 italic">
              LCA Desk Trinidad module &mdash; pricing from $499/month &mdash;
              launching Q4 2026
            </p>
          </div>
        </motion.div>
