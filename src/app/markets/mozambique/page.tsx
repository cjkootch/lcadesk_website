...
export default function MozambiquePage() {
  ...
  return (
    <main className="min-h-screen bg-surface">
      <HeroSection
        eyebrow="\u{1F1F2}\u{1F1FF} Mozambique"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <p className="text-sm font-medium text-text-primary">INP</p>
        ...
        >
          <div className="bg-card rounded-xl border border-border p-6 max-w-md w-full text-center">
            ...
            <p className="text-sm text-text-secondary mb-4">
              Be the first to know when the Mozambique module launches.
            </p>
            {submitted ? (
            ...
            <p className="text-xs text-text-muted mt-4 italic">
              LCA Desk Mozambique module &mdash; pricing from $349/month &mdash;
              launching 2027
            </p>
          </div>
        </motion.div>
